        ...
        <section class="theme-bg pos-r page-section-ptb">
          <div class="container">
             <div class="row">
                ...
                <div class="col-md-6">
                  <div class="section-title">
                    <h1 class="text-white">Nuevo paciente</h6>
                  </div>
                    <p class="text-white">Registre a un nuevo paciente</p>
                  <a class="button button-border white mt-20" href="registroP.jsp"> Registrar </a>
                </div>
             </div>
          </div>   
        </section>
